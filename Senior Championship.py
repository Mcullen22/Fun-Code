...
KK_Teams=['Ballyhale', 'Bennettsbridge', 'Clara', 'Dicksboro', 'Erins Own', 'Graigue Ballycallan', 'Glenmore', 'James Stephens', 'Lisdowney', 'Mullinavat', 'O Loughlin Gaels', 'Tullaroan']
KK_Teams.sort()

def championship_draw():
    print ("The 2022 Senior teams are", KK_Teams)
